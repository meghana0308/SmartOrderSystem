...
namespace SmartOrder.API.Migrations
{
    ...
    [Migration("20260103125836_AddNotificationsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartOrder.API.Models.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SmartOrder.API.Models.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SmartOrder.API.Models.Entities.Notification", b =>
                {
                    b.HasOne("SmartOrder.API.Models.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartOrder.API.Models.Entities.Order", b =>
                {
                    ...
                    b.HasOne("SmartOrder.API.Models.Entities.ApplicationUser", "Customer")
                        .WithMany()
